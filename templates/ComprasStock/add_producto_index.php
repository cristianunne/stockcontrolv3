                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions" style="text-align: center">
                                            <?= $this->Html->link($this->Html->tag('span', '', ['class' => 'fas fa-eye', 'aria-hidden' => 'true']),
                                                ['controller' => 'ProductosComprasstock', 'action' => 'add', $id_compras_stock, $producto->idproductos,
                        ...
                        <div class="card-footer">
                            ...
                            <div class="pull-left">
                                <?= $this->Html->link("Volver", ['action' => 'view', $id_compras_stock], ['class' => 'btn btn-danger btn-flat']) ?>
                            </div>
                        </div>
