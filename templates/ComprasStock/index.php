                        ...
                        <div class="card-header" style="position: relative;">
                            ...
                            <div class="card-tools">
                                ...
                                <?=  $this->Html->link(
                                    ...
                                    ['controller' => 'ComprasStock', 'action' => 'add'], ['class' => 'btn bg-teal', 'escape' => false]) ?>
                        ...
                        <div class="card-body table-responsive">
                            <table id="tabladata" class="table table-bordered table-hover dataTable">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><?= $this->Paginator->sort('Empleado Asignado') ?></th>
                                ...
                                <?php foreach ($compras_stock as $compras): ?>
                                    <tr>
                                        ...
                                        <td class="dt-center align-middle"><?= h($compras->status) ?></td>
                                        <td class="dt-center align-middle"><?= h($compras->Users->firstname . ' ' . $compras->Users->lastname) ?></td>
                                        <td class="dt-center align-middle"><?= h($compras->created) ?></td>
                                        <td class="dt-center align-middle"><?= h($compras->modified) ?></td>

                                           <?php if(isset($compras->UsersComprador)):  ?>
                                               <td class="dt-center align-middle"><?= h($compras->UsersComprador->firstname . ' ' . $compras->UsersComprador->lastname) ?></td>
