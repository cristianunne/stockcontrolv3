                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-footer">
                                <div class="pull-left">
                                    <?=  $this->Html->link(
                                        'Volver',
                                        ['controller' => 'Campaign', 'action' => 'indexUser'],
                                ...
                                <?php if ($campaign->status): ?>
                                    <div class="card-tools">
                                        <?=  $this->Html->link(
                                            ...
                                            ['controller' => 'VentasTemp', 'action' => 'selectCliente', $campaign->idcampaign],
                                ...
                                <table id="tabladata" class="table table-bordered table-hover dataTable">
                                    ...
                                    <?php foreach ($campaign->ventas as $ventas): ?>
                                        <tr>
                                            ...
                                            <td class="dt-center font-weight-bold align-middle"><?= h($ventas->clientes_idclientes) ?></td>
