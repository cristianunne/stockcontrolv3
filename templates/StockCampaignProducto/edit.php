        ...
        <div class="container">
            <div class="card">
                <div class="card-header" style="position: relative;">
                    <h3 class="card-title">Editar Producto al Stock del Camion</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6 card box-simm-shadow" style="margin: 0 auto; padding: 1.25rem">
                            ...
                            <div class="form-group" style="margin-top: 40px;">
                                ...
                                <div class="pull-left">
                                    <?= $this->Html->link("Volver", ['controller' => 'Campaign' , 'action' => 'stockCamionCampaign',
                                        $idstock_camion_campaign, $id_camion, $idcampaign], ['class' => 'btn bg-redrose']) ?>
                                </div>
